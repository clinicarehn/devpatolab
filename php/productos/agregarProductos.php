...
$precio_venta2 = isset($_POST['precio_venta2']) ? floatval($_POST['precio_venta2']) : 0;
$precio_venta3 = isset($_POST['precio_venta3']) ? floatval($_POST['precio_venta3']) : 0;
$precio_venta4 = isset($_POST['precio_venta4']) ? floatval($_POST['precio_venta4']) : 0;

$cantidad_minima = isset($_POST['cantidad_minima']) ? floatval($_POST['cantidad_minima']) : 0;
$cantidad_maxima = isset($_POST['cantidad_maxima']) ? floatval($_POST['cantidad_maxima']) : 0;
