...
if($result_ConsultaPagos->num_rows==0){
	...
	VALUES ('$pagos_grupal_id','$facturas_id','$tipo_pago','$fecha_factura','$importe','$efectivo','$cambio','$tarjeta','$usuario','$estado_pago','$empresa_id','$fecha_registro')";$query = $mysqli->query($insert);
